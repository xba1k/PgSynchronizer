...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pgsynchronizer: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pgsynchronizer ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/config_util.o: config_util.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/config_util.o config_util.c
...
${OBJECTDIR}/pg_util.o: pg_util.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pg_util.o pg_util.c

${OBJECTDIR}/sync_util.o: sync_util.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sync_util.o sync_util.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pgsynchronizer
